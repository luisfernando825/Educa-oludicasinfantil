...
const BonusCard = ({ number, title, originalPrice, image }: { number: number; title: string; originalPrice: string; image: string }) => (
  <div className="bg-white p-6 rounded-xl border-2 border-dashed border-orange-200 relative overflow-hidden shadow-[0_10px_25px_-10px_rgba(255,90,31,0.2)] flex flex-col items-center text-center group">
    <div className="absolute top-0 right-0 bg-green-500 text-white text-[10px] font-bold px-3 py-1 rounded-bl-lg uppercase tracking-wider z-10">
      Grátis Hoje
    </div>
    ...
    <div className="w-full aspect-square mb-4 flex items-center justify-center bg-slate-50 rounded-lg overflow-hidden relative">
      ...
      />
      <div className="absolute top-2 left-2 text-orange-500 font-black text-xl opacity-20">#{number}</div>
    </div>
    ...
    <div className="mt-auto w-full pt-4 border-t border-slate-50">
      <p className="text-slate-400 text-sm line-through decoration-red-400/50">Valor original: {originalPrice}</p>
...
const VSLPlayer = memo(() => (
  <div className="relative w-full max-w-md md:max-w-2xl mx-auto rounded-[2rem] shadow-2xl overflow-hidden mb-8 border-4 border-white bg-slate-900">
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-orange-100 selection:text-orange-900">
        ...
        {showUpsellModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <button 
                onClick={() => setShowUpsellModal(false)}
                className="absolute top-4 right-6 text-slate-400 hover:text-slate-600 transition-colors z-10"
              >
                <X className="w-6 h-6" />
              </button>
              
              <div className="p-8 md:p-10 text-center">
                <p className="text-[#7C8BFF] font-bold text-sm mb-2 flex items-center justify-center gap-2">
                  ⌛ Espere! Não perca essa oportunidade
                </p>
                
                <h3 className="text-3xl font-black text-blue-700 mb-1">Plano Completo</h3>
                <p className="text-[#A0AEC0] text-[10px] font-black tracking-[0.2em] uppercase mb-4">HOJE POR APENAS</p>
                
                <div className="flex items-start justify-center gap-1 mb-6">
                  <span className="text-xl font-bold text-[#8B5CF6] mt-2">R$</span>
                  <span className="text-7xl font-black text-[#8B5CF6] tracking-tighter drop-shadow-sm">19,90</span>
                </div>
                ...
                <ul className="space-y-3 mb-8 text-left max-w-[240px] mx-auto">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-3 text-[#4A5568] font-bold text-sm">
                      <div className="w-5 h-5 rounded-full border-2 border-[#7C8BFF] flex items-center justify-center flex-shrink-0">
                        <Check className="w-3 h-3 text-[#7C8BFF] stroke-[4]" />
                      </div>
                      {item}
                    </li>
                  ))}
                ...
                <div className="bg-white rounded-2xl border-2 border-[#FF5A1F] p-5 mb-8 relative">
                  ...
                  <ul className="space-y-2 mt-2 text-left">
                    {[
                      ...
                      <li key={i} className="flex items-center gap-3 text-[#4A5568] text-xs font-bold">
                ...
                <button className="w-full py-5 rounded-2xl bg-[#1ED760] text-white font-black text-xl shadow-[0_10px_20px_-5px_rgba(30,215,96,0.5)] hover:bg-[#19C356] transition-all transform hover:scale-105 active:scale-95 flex items-center justify-center gap-2 mb-6">
                ...
                <button 
                  onClick={() => setShowUpsellModal(false)}
                  className="text-slate-400 text-xs font-bold hover:text-slate-600 transition-colors underline decoration-2 underline-offset-4"
                >
      ...
      {/* Top Bar */}
      <div className="bg-[#FF5A1F] text-white py-2 px-4 text-center text-sm font-bold tracking-wide">
      ...
      <header className="relative pt-12 pb-24 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-orange-50 text-[#FF5A1F] px-4 py-1 rounded-full text-sm font-bold mb-6 border border-orange-100">
      ...
      <section className="py-24 bg-orange-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#FF5A1F] font-bold tracking-widest uppercase text-sm">Presentes Exclusivos</span>
            ...
            <div className="bg-[#FF5A1F] rounded-3xl p-6 md:p-8 shadow-2xl max-w-md w-full relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex justify-center items-center gap-2 md:gap-4">
                  ...
                  <div className="text-3xl md:text-4xl font-black text-white/50 animate-pulse">:</div>
                  <div className="bg-orange-700/50 backdrop-blur-sm rounded-2xl p-3 md:p-4 w-20 md:w-24 flex flex-col items-center justify-center border border-orange-400/30 shadow-inner">
          ...
          <div className="flex justify-center items-center max-w-lg mx-auto">
            ...
            <div className="bg-white p-1 rounded-[2.5rem] border-[6px] border-[#FF5A1F] relative z-20 flex flex-col h-full shadow-[0_30px_60px_-12px_rgba(255,90,31,0.3)] w-full">
              ...
              <div className="p-8 flex flex-col h-full">
                ...
                <button className="w-full py-5 rounded-2xl bg-[#1ED760] text-white font-black text-xl shadow-[0_10px_20px_-5px_rgba(30,215,96,0.5)] hover:bg-[#19C356] transition-all transform hover:scale-105 active:scale-95 flex flex-col items-center justify-center gap-1 group">
                  <span>QUERO MEU ACESSO AGORA</span>
                  <span className="text-2xl">🔥</span>
                </button>
              </div>
      ...
      <section className="py-24 bg-[#0F172A] text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <button 
            onClick={scrollToPlans}
            className="bg-blue-600 hover:bg-blue-700 text-white text-xl font-black px-8 py-4 rounded-2xl shadow-2xl shadow-blue-500/20 transition-all transform hover:scale-105"
          >
